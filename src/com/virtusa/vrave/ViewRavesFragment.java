...
public class ViewRavesFragment extends Fragment {
	...
	// keys for hash set
    String[] from = { "rTitle", "rMessage", "rSender" };
    // ui elements in the search suggesions
    int[] to = { R.id.ravetitle,  R.id.raveexplanation, R.id.raveperson };
    ListView l;
	@Override
	...
	public void populateRaveList(){
        ...
        raveList.add(rave6);
        SimpleAdapter adapter = new SimpleAdapter(getActivity(),raveList,R.layout.view_rave_list_item, from,to);
